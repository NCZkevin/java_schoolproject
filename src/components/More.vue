<template>
  <div id="more">
      ...
      <el-card :body-style="{ padding: '0px' }">
        <div style="padding: 14px;">
          ...
          <!-- <li class="ul-menu-item" v-for="(item, index) in items" @click="chooseTab(index)">
            ...
            <!--<li class="ul-menu-item" @click="chooseTab(0)">
             导入
            </li>
            <li class="ul-menu-item" @click="chooseTab(1)">
             导出
            </li>
          </ul>
        </div>
    ...
    <el-menu default-active="2" class="el-menu-vertical-demo"  theme="dark">
      <el-menu-item @click="chooseTab(0)">导入</el-menu-item>
      <el-menu-item @click="chooseTab(1)">导出</el-menu-item>
    </el-menu>
  </el-col>
    ...
    <el-col :span="18" :offset="2" v-show="aIndex === 1" class="download">
      <a href="http://127.0.0.1:8081/poidownload">
